...
module.exports.loader = (data, option) => {
	switch (option) {
		case "warn":
			console.log(chalk.bold.hex("#EEEEEE").bold('[ Eris ] ') + data);
			break;
		case "error":
			console.log(chalk.bold.hex("#FFFFFF").bold('[ Eris ] ') + data);
			break;
		default:
			console.log(chalk.bold.hex("#FF0000", "#FF6699").bold(`[ Eris ] `) + data);
			break;
	}
}